...
result=$(kubectl -n bookinfo get deployments -o json | \
...
echo -en "\e[91mCould not send results. Try again with logging enabled. Copy logs from /root/exercise/send.log and send them to our support.\e[0m\n"
